...
public sealed partial class OverviewControl : UserControl
{
	...
	public static readonly DependencyProperty FatBrushProperty =
		DependencyProperty.Register("FatBrush", typeof(SolidColorBrush), typeof(OverviewControl), new PropertyMetadata(new SolidColorBrush(Colors.Black), OnBrushChanged));
	...
	public static readonly DependencyProperty DataLabelBrushProperty =
		DependencyProperty.Register("DataLabelBrush", typeof(SolidColorBrush), typeof(OverviewControl), new PropertyMetadata(new SolidColorBrush(Colors.Black), OnBrushChanged));
	...
	public static readonly DependencyProperty TrackBackgroundBrushProperty =
		DependencyProperty.Register("TrackBackgroundBrush", typeof(SolidColorBrush), typeof(OverviewControl), new PropertyMetadata(new SolidColorBrush(Colors.Black), OnBrushChanged));

	private static void OnBrushChanged(DependencyObject dependencyObject, DependencyPropertyChangedEventArgs args)
	{
		if (dependencyObject is not OverviewControl chartControl) return;
